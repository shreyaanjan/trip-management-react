            ...
            <section className="back-color-image sm:h-screen md:rounded-2xl overflow-hidden home-section h-screen pt-32">
                <div className="bg-img">
                    <div className="container mx-auto">
                        ...
                        <div>
                            <form className="mt-12 bg-white rounded-xl px-4 py-4 flex flex-wrap items-center">
                                <div className="flex items-center gap-3 border-r pr-6">
                                    <i className="bi bi-geo-alt text-lg text-gray-500"></i>
                                    <div className="flex flex-col">
                                        <label className="text-xs text-gray-400">Destinations</label>
                                ...
                                <div className="flex items-center gap-3 border-r pr-6">
                                    ...
                                    <div className="flex flex-col">
                                        <label className="text-xs text-gray-400">All Activity</label>
                                        <select className="text-sm font-semibold focus:outline-none bg-transparent">
                                ...
                                <div className="w-2/12 flex items-center gap-3 border-r pr-6">
